...
"Allowed C types: int, long, int64_t, int32_t, float, double, char, Student"
...
int run(Arguments *args, char *file_name)
{
    ...
    else
    {
        ...
        {
            puts("Unexpected error 1 occured!");
        ...
        if (return_code == OK)
        {
            ...
            {
                puts("Unexpected error 2 occured!");
                return_code = ERR_UNEXPECTED;
            }
        }
    }
...
int run_convert_t2b(Types type, FILE *in, FILE *out)
{
    ...
    switch (type)
    {
        ...
        case CHAR:
            ...
            break;
        case STUDENT:
            return_code = CUSTOM_CONVERT_T2B(student, in, out, scan_student);
            break;
        default:
            puts("Unexpected error 3 occured!");
            return_code = ERR_UNEXPECTED;
    }
...
int run_convert_b2t(Types type, FILE *in, FILE *out, char *delimeter, char *end)
{
    ...
    switch (type)
    {
        ...
        case CHAR:
            ...
            break;
        case STUDENT:
            return_code = CUSTOM_CONVERT_B2T(student, in, out, print_student, delimeter, end);
            break;
        default:
            puts("Unexpected error 4 occured!");
            return_code = ERR_UNEXPECTED;
    }
